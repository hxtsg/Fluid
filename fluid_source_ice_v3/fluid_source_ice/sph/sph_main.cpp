...
void CALLBACK onFrameMove(double fTime, float fElapsedTime, void* pUserContext)
{
	...
	for(unsigned int n = 0; n<g_pSPHSystem->getPointCounts(); n++)
	{
		...
		pVertices->color = D3DCOLOR_XRGB((int)(255), (int)(255), (int)(255));
...
//	g_HUD.AddButton( IDC_ADDVOLUMN, L"Add", 35, iY, 125, 22 );

	//create sph system
	g_pSPHSystem = getSPHSystem();
	g_ghostSPHSystem = getGhostSPHSystem();
	g_ghostSPHSystem->SetFluidPointer( g_pSPHSystem );
