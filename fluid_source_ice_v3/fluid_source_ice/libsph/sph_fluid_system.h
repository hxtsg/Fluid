...
namespace SPH
{
	...
	public:
		...
		virtual void AddVolumn(void);
		virtual void SetFluidPointer( System * );
	private:
		/** 初始化系统
		*/
		...
		void _computeTemprature(void); // 计算粒子的温度
	...
	class GhostFluidSystem : public FluidSystem
	{
		
	public:
		
		void SetFluidPointer( System * sph ){
			this->fluidSystem = sph;
