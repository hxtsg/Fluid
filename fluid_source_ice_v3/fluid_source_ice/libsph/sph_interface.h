...
public:
	...
	virtual void AddVolumn(void) = 0;
	virtual void SetFluidPointer( System * ) = 0;


	//virtual void _addFluidVolume(const fBox3& fluidBox, float spacing) = 0;
};
...
SPH_API SPH::System * getGhostSPHSystem(void);
};
